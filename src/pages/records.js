...
const rows = [
    createData('2023-11-24',	'NA',	'NA',	'庄上',	'庄上',	'大光 🌟',	'NA',	'NA',			'Chole',	'Joe S, Joe Z'),
    createData('2023-11-24',	'7', '3(2nd Round)',	'K',	'7',	'A', 	'3(2nd Round)🌟',	'5',	'Elaine',	'TJ' ),
    createData('2023-11-24',	'8',	'7',	'10',	'A 🌟',	'8',	'9',	'5',	'Joe Z',	'Joe S'),
    createData('2023-12-08', 'A',	'A',	'3 (2nd Round)',	'Q',	'3(2nd Round) 🌟',	'A',	'Q',	'Chloe',	'Joe Sun'),
    createData('2023-12-08', '10?',	'10?',	'10?',	'10?',	'A (大光) 🌟', '10?',	'10?',	'Chloe',	'N/A'),
    createData('2023-12-15', '9',	'2(2nd Round) 🌟',	'K',	'10',	'10', '6',	'7',	'TJ',	'Joe Sun'),
    createData('2023-12-15',	'Q',	'5',	'A',	'9',	'2(2nd Round) 🌟',	'Q',	'2',	'Chloe',	'Joe Sun'),
    ...
    createData('2023-12-29',	'10',	'9',	'8',	'8',	'2(2nd Round)🌟',	'7',	'4','Chole',	'Jack'),
    createData('2023-12-29', '6',	'K',	'A',	'9',	'2(2nd Round) 🌟',	'A',	'6',	'Chole',	'Elaine, Joe S'),	
    createData('2023-12-29',	'8',	'2(2nd Round) 🌟',	'A+',	'Q',	'A',	'9',	'A+',			'TJ',	'Joe S, Linyi')													
  ];
